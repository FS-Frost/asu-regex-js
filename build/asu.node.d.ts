...
export declare function newSectionExtraData(): SectionExtraData;
export declare function sectionExtraDataToString(info: SectionExtraData): string;
export type AttachedFont = {
	name: string;
	data: string[];
};
export declare function AttachedFontToString(file: AttachedFont): string;
export type SectionFonts = {
	files: AttachedFont[];
};
export declare function newSectionFonts(): SectionFonts;
export declare function sectionFontsToString(info: SectionFonts): string;
export type AttachedGraphic = {
	name: string;
	data: string[];
};
export declare function AttachedGraphicToString(file: AttachedGraphic): string;
export type SectionGraphics = {
	files: AttachedGraphic[];
};
export declare function newSectionGraphics(): SectionGraphics;
export declare function sectionGraphicsToString(info: SectionGraphics): string;
export declare const ProjectGarbagePropertyAutomationScripts: string;
export declare const ProjectGarbagePropertyExportFilters: string;
export declare const ProjectGarbagePropertyExportEncoding: string;
export declare const ProjectGarbagePropertyLastStyleStorage: string;
export declare const ProjectGarbagePropertyAudioFile: string;
export declare const ProjectGarbagePropertyVideoFile: string;
export declare const ProjectGarbagePropertyTimecodesFile: string;
export declare const ProjectGarbagePropertyKeyframesFile: string;
export declare const ProjectGarbagePropertyVideoARMode: string;
export declare const ProjectGarbagePropertyVideoARValue: string;
export declare const ProjectGarbagePropertyVideoZoomPercent: string;
export declare const ProjectGarbagePropertyScrollPosition: string;
export declare const ProjectGarbagePropertyActiveLine: string;
export declare const ProjectGarbagePropertyVideoPosition: string;
export type SectionProjectGarbage = {
	comments: string[];
	properties: Map<string, string>;
};
export declare function newProjectGarbage(): SectionProjectGarbage;
export declare function sectionProjectGarbageToString(info: SectionProjectGarbage): string;
export declare const ScriptInfoPropertyTitle: string;
export declare const ScriptInfoPropertyScriptType: string;
export declare const ScriptInfoPropertyWrapStyle: string;
export declare const ScriptInfoPropertyPlayResX: string;
export declare const ScriptInfoPropertyPlayResY: string;
export declare const ScriptInfoPropertyScaledBorderAndShadow: string;
export declare const ScriptInfoPropertyYCbCrMatrix: string;
export declare const ScriptInfoPropertyOriginalScript: string;
export declare const ScriptInfoPropertyOriginalTranslation: string;
export declare const ScriptInfoPropertyOriginalEditing: string;
export declare const ScriptInfoPropertyOriginalTiming: string;
export declare const ScriptInfoPropertySynchPoint: string;
export declare const ScriptInfoPropertyScriptUpdatedBy: string;
export declare const ScriptInfoPropertyUpdateDetails: string;
